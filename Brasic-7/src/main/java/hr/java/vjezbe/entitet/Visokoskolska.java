...
public interface Visokoskolska {
     ...
     */
    public BigDecimal izracunajKonacnuOcjenuStudijaZaStudente(List<hr.java.vjezbe.entitet.Ispit> ispiti, Ocjena ocjenaPisanjeZavrsnogRada, Ocjena ocjenaObranaZavrsnogRada);
     ...
     */
    default BigDecimal odrediProsjekOcjenaNaIspitima(List<hr.java.vjezbe.entitet.Ispit> ispiti) throws NemoguceOdreditiProsjekStudentaException {
    ...
    private hr.java.vjezbe.entitet.Ispit[] filtrirajPolozeneIspite(List<hr.java.vjezbe.entitet.Ispit> ispiti){
        hr.java.vjezbe.entitet.Ispit pozIspiti[] = null;
     ...
     */
    default hr.java.vjezbe.entitet.Ispit[] filtrirajIspitePoStudentu(List<hr.java.vjezbe.entitet.Ispit> ispiti, Student student){
