...
public class VeleucilisteJave extends ObrazovnaUstanova implements Visokoskolska {
    ...
    public VeleucilisteJave(long id, String naziv, List<Predmet> predmeti, List<Profesor> profesori, List<hr.java.vjezbe.entitet.Student> studenti, List<hr.java.vjezbe.entitet.Ispit> ispiti ) {
    ...
    public hr.java.vjezbe.entitet.Student odrediNajuspjesnijegStudentaNaGodini(Integer godina) {
        List<hr.java.vjezbe.entitet.Ispit> ispiti = VeleucilisteJave.this.getIspiti();
