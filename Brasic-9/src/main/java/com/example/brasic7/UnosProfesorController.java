    ...
    public void saveProfesor() {
        ...
        Connection connectionID;
        {
            try {
                ...
                List<Profesor> profesorList = BazaPodataka.getAllProfesorsFromDatabase(connectionID);
                id = (long) (profesorList.size() + 1);
        ...
        if(errorMessages.isEmpty()) {
            Profesor newProfesor = new Profesor(id + 1,sifra,ime,prezime,titula);
...
*/
            Connection connection;
            {
                try {
                    ...
                    BazaPodataka.insertNewProfesorToDatabase(newProfesor);
                } catch (SQLException | IOException e) {
                    e.printStackTrace();
                }
            }
